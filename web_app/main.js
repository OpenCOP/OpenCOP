var cop = ( function() {
		...
		var init = function() {
			...
			var WMSGetFeatureInfoControl = new OpenLayers.Control.WMSGetFeatureInfo({
				...
				vendorParams : {
					buffer : 10
				}, //geoserver param, don't have to click dead center, I believe ESRI ignores it
			...
			function populateIcons() {
				...
				if(!available_icons_div)
					return // div is "lazy loaded first time" edit panel is viewed; prior to that, the div won't exist
						...
						items : [{
							...
							listeners : {
								afterrender : function(field) {
									field.focus(false, // true = select existing text in box
									100)    // delay (ms)
								}
							}
						}, {
